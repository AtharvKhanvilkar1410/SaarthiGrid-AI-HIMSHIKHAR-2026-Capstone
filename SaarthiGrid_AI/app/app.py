...
def render_about_tab() -> None:
    ...
    st.write(
        "SaarthiGrid AI is an Agentic AI project that helps farmers "
    ...
    st.markdown(
        """<footer class="saarthi-footer">
            <div>
                ...
                <p>Farmer Subsidy and Advisory Navigation Agent</p>
                <p>Agentic AI project</p>
            </div>
            <div>
